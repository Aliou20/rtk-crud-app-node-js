...
import "../App.css";
import { todosAdd, updateTodos } from "../feature/Slice1";
    ...
    <>
      <form onSubmit={handleSubmit}>
        ...
        { todosState.addTodoStatus === "success" ? (
            <Alert severity="success">Task Ajouter ...</Alert>
          ) : null }
        ...
        { todosState.updateTodoStatus === "success" ? (
            <Alert severity="success">Task modifier ...</Alert>
          ) : null }
        ...
        { todosState.deleteTodoStatus === "success" ? (
            <Alert severity="warning">Task supprimer ...</Alert>
          ) : null }
